...
import { XTMMiningHistory } from "@/types/MiningStats";
import XTM_HISTORY from "@/utils/history/xtm-history.json";
import { getXtmChartHistory } from "@/utils/xtm-charts";
